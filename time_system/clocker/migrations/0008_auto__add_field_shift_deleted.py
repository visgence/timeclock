...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Shift.deleted'
        db.add_column('Shift', 'deleted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Shift.deleted'
        db.delete_column('Shift', 'deleted')


    models = {
        u'clocker.employee': {
            'Meta': {'ordering': "['username']", 'object_name': 'Employee'},
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 6, 0, 0)'}),
